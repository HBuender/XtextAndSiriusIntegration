...
import org.eclipse.xtext.example.domainmodel.domainmodel.EnumerationLiteral;
...
public class DomainmodelLabelProvider extends XbaseLabelProvider {
	...
	public String text(EnumerationLiteral enumerationLiteral) {
		StringBuilder builder = new StringBuilder();
		builder.append(notNull(enumerationLiteral.getName()));
		return builder.toString();
	}
